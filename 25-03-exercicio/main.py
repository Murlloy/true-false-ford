...
while True:
    ...
    opcao = int(input("============= BEM VINDO AO RESOLVEDOR DE EXERCICIOS FORD ===============\n\n1 - Exercicio 1 -- DE 1 A 10" \
    "\n2 - Exercicio 2 -- MEDIA"\
    "\n3 - Exercicio 3 -- CONTAR TURMAS"\
    "\n4 - Exercicio 4 -- CASAS DECIMAIS"\
    "\n5 - Exercicio 5 -- SENHA 1200"\
    "\n6 - Exercicio 6 -- SOMADOR 2000 \n7 - FIBONACCI \n8 - TRIPONACCI \n9 - Sair\nDigite oque quer fazer: "))
    ...
    opcao = input("gostaria de continuar? 1 - sim, 2 não\n")
    if opcao == 2:
        break